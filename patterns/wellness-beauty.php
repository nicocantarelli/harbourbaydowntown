<?php
/**
 * Title: Wellness — Beauty & Grooming
 * Slug: harbour-bay-downtown/wellness-beauty
 * Categories: harbour-bay-downtown
 * Description: The standard directory grid (Card_Type_5) with carousel controls — a two-row track that scrolls when there are more than six cards. Heading editable via Customizer → Wellness & Spa Page → Wellness — Beauty & Grooming. Cards come from Listings of type "Wellness".
 * Inserter: no
 * Viewport Width: 1440
 */

$title = nl2br( esc_html( get_theme_mod( 'hbd_wellness_beauty_title', 'Beauty & Grooming' ) ) );

// Cards come from Listings of type "Wellness" in the "Beauty & Grooming"
// category. Until any exist, fall back to static placeholders.
$cards = hbd_get_listings( 'wellness', -1, 'beauty-grooming' );
if ( empty( $cards ) ) {
	$img   = HBD_THEME_URI . '/assets/images/';
	$cards = array(
		array( 'image' => $img . 'wellness-spa-2.png', 'pill' => 'Hair Salon',  'title' => 'Bay Hair Studio', 'link' => '#' ),
		array( 'image' => $img . 'wellness-spa-3.png', 'pill' => 'Barber',      'title' => 'Harbour Barbers', 'link' => '#' ),
		array( 'image' => $img . 'wellness-spa-1.png', 'pill' => 'Nails',       'title' => 'Polished Nail Bar', 'link' => '#' ),
		array( 'image' => $img . 'wellness-spa-3.png', 'pill' => 'Skincare',    'title' => 'Glow Skin Clinic', 'link' => '#' ),
		array( 'image' => $img . 'wellness-spa-2.png', 'pill' => 'Brows',       'title' => 'Brow & Lash Bar', 'link' => '#' ),
		array( 'image' => $img . 'wellness-spa-1.png', 'pill' => 'Grooming',    'title' => "Gentlemen's Lounge", 'link' => '#' ),
	);
}
...
?>
<!-- wp:group {"tagName":"section","className":"wellness-beauty","layout":{"type":"default"}} -->
<section class="wp-block-group wellness-beauty" data-carousel>
	<!-- wp:heading {"level":2,"className":"wellness-beauty__title","textAlign":"center"} -->
	<h2 class="wp-block-heading wellness-beauty__title has-text-align-center"><?php echo $title; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped — escaped via esc_html() above ?></h2>
	<!-- /wp:heading -->

	<!-- wp:html -->
	<div class="wellness-beauty__track" data-carousel-track>
	...
	<!-- wp:group {"className":"carousel__controls wellness-beauty__controls","layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"center"}} -->
	<div class="wp-block-group carousel__controls wellness-beauty__controls">
		<!-- wp:html -->
