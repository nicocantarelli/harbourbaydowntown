<?php
/**
 * Title: Ferries — Travel Guides
 * Slug: harbour-bay-downtown/ferry-guides
 * Categories: harbour-bay-downtown
 * Description: Special Promotions layout (intro left, carousel right) with a button and Type-4 guide cards — the same as the Stay/Dine/Shop guides. Intro editable via Customizer → Ferries Page → Ferries — Travel Guides. Cards come from blog posts in the "Travel" Guide Section.
 * Inserter: no
 * Viewport Width: 1440
 */

$title        = nl2br( esc_html( get_theme_mod( 'hbd_ferries_guides_title', 'Travel Guides' ) ) );
$body         = get_theme_mod( 'hbd_ferries_guides_body', 'Harbour Bay International Ferry Terminal connects Batam with nearby international and domestic destinations. Below is a list of ferry operators, routes, and useful information to help you plan your journey.' );
$button_label = get_theme_mod( 'hbd_ferries_guides_button_label', 'Read More' );
$button_url   = get_theme_mod( 'hbd_ferries_guides_button_url', '#' );

// Guide cards come from blog posts tagged with the "travel" Guide Section.
// Until any are tagged, fall back to static placeholders so the section isn't empty.
$cards = hbd_get_section_guides( 'travel' );
if ( empty( $cards ) ) {
	$img   = HBD_THEME_URI . '/assets/images/';
	$cards = array(
		array( 'image' => $img . 'card-stay.png',      'category' => 'Guide', 'title' => 'Getting to Batam',   'excerpt' => 'A simple guide to ferries, terminals, and what to expect on arrival.',          'date' => '14 March 2026', 'read_time' => '5 min read', 'permalink' => '#' ),
		array( 'image' => $img . 'card-dine.png',      'category' => 'Guide', 'title' => 'Immigration Tips',    'excerpt' => 'Visa-on-arrival, auto lanes, and how to clear immigration quickly.',              'date' => '10 March 2026', 'read_time' => '4 min read', 'permalink' => '#' ),
		array( 'image' => $img . 'card-shop.png',      'category' => 'Guide', 'title' => 'Terminal Amenities',  'excerpt' => 'ATMs, money changers, WiFi, lounges, and everything inside the terminal.',         'date' => '2 March 2026',  'read_time' => '6 min read', 'permalink' => '#' ),
		array( 'image' => $img . 'card-nightlife.png', 'category' => 'Guide', 'title' => 'Planning Your Trip',  'excerpt' => 'Schedules, ferry operators, and tips for a smooth crossing.',                     'date' => '28 Feb 2026',   'read_time' => '5 min read', 'permalink' => '#' ),
	);
}
?>
<!-- wp:group {"tagName":"section","className":"home-promotions stay-guides ferry-guides","layout":{"type":"default"}} -->
<section class="wp-block-group home-promotions stay-guides ferry-guides" data-carousel>
