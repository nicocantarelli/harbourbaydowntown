<?php
/**
 * Title: Shop — Special Promotions
 * Slug: harbour-bay-downtown/shop-promotions
 * Categories: harbour-bay-downtown
 * Description: Intro on the left + a carousel of promotion cards, driven by the Events & Promotions content type (type: Promotion). Cards link to each promotion's detail page. Intro editable via Customizer → Shop Page → Shop — Special Promotions.
 * Inserter: no
 * Viewport Width: 1440
 */
...
$title = nl2br( esc_html( get_theme_mod( 'hbd_shop_promotions_title', "Special\npromotions" ) ) );
$body  = get_theme_mod( 'hbd_shop_promotions_body', 'Seasonal offers, shopping deals, and limited-time experiences around Harbour Bay.' );
?>
<!-- wp:group {"tagName":"section","className":"home-promotions shop-promotions","layout":{"type":"default"}} -->
<section class="wp-block-group home-promotions shop-promotions" data-carousel>
