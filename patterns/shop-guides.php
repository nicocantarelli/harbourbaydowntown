<?php
/**
 * Title: Shop — Shop Guides
 * Slug: harbour-bay-downtown/shop-guides
 * Categories: harbour-bay-downtown
 * Description: Same as the Stay/Dine Guides section — Special Promotions layout with a button + Type-4 guide cards. Intro editable via Customizer → Shop Page → Shop — Shop Guides. The cards are static placeholders for now.
 * Inserter: no
 * Viewport Width: 1440
 */

$title        = nl2br( esc_html( get_theme_mod( 'hbd_shop_guides_title', 'Shop Guides' ) ) );
$body         = get_theme_mod( 'hbd_shop_guides_body', 'Shopping at Harbour Bay Downtown is centered at Bayfront Mall, located right by the ferry terminal. From local snacks and souvenirs to SIM cards and everyday needs, everything is easy to find in one comfortable indoor space, making it a natural stop on arrival or anytime during the day.' );
$button_label = get_theme_mod( 'hbd_shop_guides_button_label', 'Read More' );
$button_url   = get_theme_mod( 'hbd_shop_guides_button_url', '#' );

// Guide cards come from blog posts tagged with the "shop" Guide Section.
// Until any are tagged, fall back to static placeholders so the section isn't empty.
$cards = hbd_get_section_guides( 'shop' );
if ( empty( $cards ) ) {
	$img   = HBD_THEME_URI . '/assets/images/';
	$cards = array(
		array( 'image' => $img . 'card-shop.png',      'category' => 'Guide', 'title' => 'Bayfront Mall Guide', 'excerpt' => 'A floor-by-floor guide to shops, snacks, and essentials by the terminal.', 'date' => '14 March 2026', 'read_time' => '5 min read', 'permalink' => '#' ),
		array( 'image' => $img . 'card-dine.png',      'category' => 'Guide', 'title' => 'Souvenir Picks',     'excerpt' => 'The best local treats and keepsakes to take home from Batam.',          'date' => '10 March 2026', 'read_time' => '4 min read', 'permalink' => '#' ),
		array( 'image' => $img . 'card-stay.png',      'category' => 'Guide', 'title' => 'Everyday Essentials', 'excerpt' => 'Where to find SIM cards, pharmacies, and daily needs on arrival.',       'date' => '2 March 2026',  'read_time' => '6 min read', 'permalink' => '#' ),
		array( 'image' => $img . 'card-nightlife.png', 'category' => 'Guide', 'title' => 'Fashion & Lifestyle', 'excerpt' => 'A walk through the apparel and lifestyle stores along the bay.',          'date' => '28 Feb 2026',   'read_time' => '5 min read', 'permalink' => '#' ),
	);
}
?>
<!-- wp:group {"tagName":"section","className":"home-promotions stay-guides shop-guides","layout":{"type":"default"}} -->
<section class="wp-block-group home-promotions stay-guides shop-guides" data-carousel>
