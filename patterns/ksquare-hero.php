<?php
/**
 * Title: K Square Mall Hero
 * Slug: harbour-bay-downtown/ksquare-hero
 * Categories: harbour-bay-downtown
 * Description: Full-screen hero with a centered title only (no subtitle). Editable via Customizer → K Square Mall Page → K Square — Hero.
 * Inserter: no
 * Viewport Width: 1440
 */

$bg_url       = hbd_resolve_image( 'hbd_ksquare_hero_image_id', 'ksquare-hero.png' );
$heading_raw  = get_theme_mod( 'hbd_ksquare_hero_title', 'K Square Mall' );
