...
/**
 * Title: Shop — Shops
 * Slug: harbour-bay-downtown/shop-shops
 * Categories: harbour-bay-downtown
 * Description: Same as the Dine "Restaurants" grid (Card_Type_5) with carousel controls — a two-row track that scrolls when there are more than six cards. Heading editable via Customizer → Shop Page → Shop — Shops. Cards come from Listings of type Shops; falls back to placeholders until added.
 * Inserter: no
 * Viewport Width: 1440
 */

$title = nl2br( esc_html( get_theme_mod( 'hbd_shop_shops_title', 'Shops' ) ) );

// Shop cards come from Listings of type "shops" (Listings → Type: Shops).
// Until any exist, fall back to static placeholders so the section isn't empty.
$cards = hbd_get_listings( 'shops' );
if ( empty( $cards ) ) {
	$img   = HBD_THEME_URI . '/assets/images/';
	$cards = array(
		array( 'image' => $img . 'card-shop.png',      'pill' => 'Fashion',      'title' => 'Bayfront Boutique', 'link' => '#' ),
		array( 'image' => $img . 'promo-dining.png',   'pill' => 'Gifts',        'title' => 'Island Souvenirs', 'link' => '#' ),
		array( 'image' => $img . 'card-stay.png',      'pill' => 'Convenience',  'title' => 'Daily Mart', 'link' => '#' ),
		array( 'image' => $img . 'promo-surf.png',     'pill' => 'Electronics',  'title' => 'TechHub Batam', 'link' => '#' ),
		array( 'image' => $img . 'card-dine.png',      'pill' => 'Books',        'title' => 'The Book Nook', 'link' => '#' ),
		array( 'image' => $img . 'card-nightlife.png', 'pill' => 'Health',       'title' => 'Coastal Pharmacy', 'link' => '#' ),
		array( 'image' => $img . 'promo-friday.png',   'pill' => 'Kids',         'title' => 'Bay Toys', 'link' => '#' ),
		array( 'image' => $img . 'card-shop.png',      'pill' => 'Eyewear',      'title' => 'Harbour Optics', 'link' => '#' ),
		array( 'image' => $img . 'card-stay.png',      'pill' => 'Footwear',     'title' => 'Sole Mates', 'link' => '#' ),
		array( 'image' => $img . 'promo-dining.png',   'pill' => 'Beauty',       'title' => 'Aroma & Co', 'link' => '#' ),
		array( 'image' => $img . 'card-dine.png',      'pill' => 'Travel',       'title' => 'Pack & Go', 'link' => '#' ),
		array( 'image' => $img . 'promo-surf.png',     'pill' => 'Artisan',      'title' => 'Local Crafts', 'link' => '#' ),
	);
}
...
?>
<!-- wp:group {"tagName":"section","className":"shop-shops","layout":{"type":"default"}} -->
<section class="wp-block-group shop-shops" data-carousel>
	<!-- wp:heading {"level":2,"className":"shop-shops__title","textAlign":"center"} -->
	<h2 class="wp-block-heading shop-shops__title has-text-align-center"><?php echo $title; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped — escaped via esc_html() above ?></h2>
	<!-- /wp:heading -->

	<!-- wp:html -->
	<div class="shop-shops__track" data-carousel-track>
	...
	<!-- wp:group {"className":"carousel__controls shop-shops__controls","layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"center"}} -->
	<div class="wp-block-group carousel__controls shop-shops__controls">
		<!-- wp:html -->
