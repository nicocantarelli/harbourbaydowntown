...
/**
 * Title: Stay Hero
 * Slug: harbour-bay-downtown/stay-hero
 * Categories: harbour-bay-downtown
 * Description: Full-screen hero with a centered title only (no subtitle). Editable via Customizer → Stay Page → Stay — Hero.
 * Inserter: no
 * Viewport Width: 1440
 */

$bg_url       = hbd_resolve_image( 'hbd_stay_hero_image_id', 'stay-hero.png' );
$heading_raw  = get_theme_mod( 'hbd_stay_hero_title', "Stay by the\nWaterfront" );
