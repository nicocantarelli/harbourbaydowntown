...
/**
 * Title: Dine Hero
 * Slug: harbour-bay-downtown/dine-hero
 * Categories: harbour-bay-downtown
 * Description: Full-screen hero with a centered title only. Editable via Customizer → Dine Page → Dine — Hero.
 * Inserter: no
 * Viewport Width: 1440
 */

$bg_url       = hbd_resolve_image( 'hbd_dine_hero_image_id', 'dine-hero.png' );
$heading_raw  = get_theme_mod( 'hbd_dine_hero_title', "A Taste of\nthe Coast" );
