<?php
/**
 * Title: Ferry Services Hero
 * Slug: harbour-bay-downtown/ferry-hero
 * Categories: harbour-bay-downtown
 * Description: Full-screen hero with a centered title only (no subtitle). Editable via Customizer → Ferries Page → Ferries — Hero.
 * Inserter: no
 * Viewport Width: 1440
 */

$bg_url       = hbd_resolve_image( 'hbd_ferries_hero_image_id', 'ferry-hero.png' );
$heading_raw  = get_theme_mod( 'hbd_ferries_hero_title', 'Ferry Services' );
